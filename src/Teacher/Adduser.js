...
export const Adduser = () => {
  ...
  return (
    <Home>
        ...
        <TextField size='small' id="outlined-basic" label="Age" variant="outlined" onChange={(e)=> setAge(e.target.value)} /><br></br>
        <TextField size='small' id="outlined-basic" label="Mobile No" variant="outlined"  onChange={(e)=> setMobile(e.target.value)}/><br></br>
        <TextField size='small' id="outlined-basic" label="Email" variant="outlined" onChange={(e)=> setEmail(e.target.value)} /><br></br>
        <TextField size='small' id="outlined-basic" label="Location" variant="outlined" onChange={(e)=> setLocation(e.target.value)} /><br></br>
